"""
AES Key Expansion GUI - Verbose (menampilkan K1..K10 dan semua langkah)
- Masukkan Plaintext dan CipherKey (ASCII). Akan dipad/truncate ke 16 byte otomatis.
- Klik "Generate" untuk melihat detail perhitungan Key Expansion dan K1..K10.
- Klik "Save Output" untuk menyimpan hasil.
"""
...
def key_expansion_verbose(key_hex_matrix):
    ...
    steps = {}  # map i -> info about how Wi was generated
    # first 4 words are initial, no steps
    for i in range(4):
        steps[i] = {
            "generated_from": None,
            "word": words[i].copy(),
